...
<footer id="colophon" aria-label="Site Footer" class="bg-white">
...
<footer id="colophon">
	...
	<?php if ( is_active_sidebar( 'sidebar-1' ) ) : ?>
		<aside role="complementary" aria-label="<?php esc_attr_e( 'Footer', 'fataniestate-com' ); ?>">
			<?php dynamic_sidebar( 'sidebar-1' ); ?>
		</aside>
	<?php endif; ?>

	<?php if ( has_nav_menu( 'menu-2' ) ) : ?>
		<nav aria-label="<?php esc_attr_e( 'Footer Menu', 'fataniestate-com' ); ?>">
			<?php
			wp_nav_menu(
				array(
	...
	<div>
		<?php
		$fataniestate_com_blog_info = get_bloginfo( 'name' );
		if ( ! empty( $fataniestate_com_blog_info ) ) :
			?>
		...
		printf(
			...
			esc_url( __( 'https://wordpress.org/', 'fataniestate-com' ) ),
			'WordPress'
		);
		?>
	</div>
